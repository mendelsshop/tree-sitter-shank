...
enum ts_symbol_identifiers {
  ...
  sym_basic_type = 50,
  sym_array_type = 51,
  sym_delclaration_array_type = 52,
  sym_declaration_type = 53,
  sym_type = 54,
  aux_sym_function_definition_repeat1 = 55,
  aux_sym_function_definition_repeat2 = 56,
  aux_sym_constant_repeat1 = 57,
  aux_sym_comparison_operator_repeat1 = 58,
  aux_sym_block_repeat1 = 59,
  aux_sym__parameters_repeat1 = 60,
  aux_sym_parameter_repeat1 = 61,
  anon_alias_sym_isnot = 62,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 5), SHIFT_REPEAT(33),
  [22] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 5), SHIFT_REPEAT(33),
  [25] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 5), SHIFT_REPEAT(77),
  [28] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 5), SHIFT_REPEAT(21),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 5),
  [33] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 6),
  [35] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 2, .production_id = 6),
  [37] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comparison_operator_repeat1, 3, .production_id = 8),
  [39] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 3, .production_id = 8),
  [41] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_comparison_operator_repeat1, 3, .production_id = 9),
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_comparison_operator_repeat1, 3, .production_id = 9),
  ...
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 5), SHIFT_REPEAT(2),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 5), SHIFT_REPEAT(2),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 2, .production_id = 5),
  ...
  [93] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat1, 2), SHIFT_REPEAT(96),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 4, .production_id = 10),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_block_repeat1, 4, .production_id = 10),
  ...
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 4),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(73),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [114] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat2, 2), SHIFT_REPEAT(98),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_function_definition_repeat2, 2),
  [119] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_constant_repeat1, 2),
  [121] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_constant_repeat1, 2), SHIFT_REPEAT(73),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_constant, 5),
  [126] = {.entry = {.count = 1, .reusable = true}}, SHIFT(92),
  [128] = {.entry = {.count = 1, .reusable = true}}, SHIFT(16),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_declaration_type, 1),
  [132] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_parameter_repeat1, 2), SHIFT_REPEAT(92),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_parameter_repeat1, 2),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 2),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2),
  [141] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2), SHIFT_REPEAT(54),
  ...
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 1),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_basic_type, 5),
  [158] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [160] = {.entry = {.count = 1, .reusable = true}}, SHIFT(12),
  [162] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 4),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 2),
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameters, 3),
  [168] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [170] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_delclaration_array_type, 7),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_constant_repeat1, 4),
  ...
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_parameter, 5),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_array_type, 3),
  ...
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 5, .production_id = 7),
  ...
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 5, .production_id = 3),
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 5, .production_id = 2),
  ...
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_definition, 4, .production_id = 1),
